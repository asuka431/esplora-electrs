...
* Update rust-baricoin to 0.14
* Optimize block headers processing during startup


# 0.3.1 (20 Aug 2018)

* Reconnect to baricoind only on transient errors
...
* Handle disconnections from baricoind by retrying
...
* Allow specifying custom baricoind data directory
...
* Announcement: https://lists.linuxfoundation.org/pipermail/baricoin-dev/2018-July/016190.html
