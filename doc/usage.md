...
[latest Baricoin Core](https://baricoincore.org/en/download/) (0.16+)
...
## Baricoind configuration

Allow Baricoin daemon to sync before starting Electrum server:
```bash
$ baricoind -server=1 -txindex=0 -prune=0
```
...
Otherwise, [`~/.baricoin/.cookie`](https://github.com/baricoin/baricoin/blob/0212187fc624ea4a02fc99bc57ebd413499a9ee1/contrib/debian/examples/baricoin.conf#L70-L72) will be read, allowing this server to use baricoind JSONRPC interface.
...
2018-08-17T18:27:42 - INFO - listing block files at "/home/user/.baricoin/blocks/blk*.dat"
...
$ docker run --network host \
             --volume /home/roman/.baricoin:/home/user/.baricoin:ro \
